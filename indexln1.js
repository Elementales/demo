...
const libln1 = require('./libln1')

// Se instancia el primer método de la librería 
// para leer contenido desde URL
const webpage = libln1.leerWebPage(URL, function(error, valores){
  ...
  if(error){
    ...
    const menciones = libln1.contarMenciones(valores)
