module.exports = {
  ...
  // Se define un m�todo local, para leer contenido Web
  leerWebPage: function (url, callback) {
    ...
    request(url, function (err, resp, html) {
      if (!err) {
        ...
        // Obtener bloque de "anuncios" de la p�gina
        let anuncios = $('#ContenedorListadoAvisos')

                // noticias.childNodes.forEach( function(item, index){
        //   console.log("Anuncio: ", index, item)
        // })

        // Obtener dato de uso de los anuncios
